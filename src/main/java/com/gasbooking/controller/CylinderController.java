...
@RestController
	...
	public ResponseEntity<?> updateCylinder(@RequestBody Cylinder cylinder) throws CylinderNotFoundException {
		Cylinder updatedCylinder = cylinderService.updateCylinder(0, cylinder);
	...
	public ResponseEntity<?> viewCylinderByType(String type) throws  CylinderNotFoundException {
        ...
        @GetMapping("/getSingleCylinder/{cylinderId}")
	public ResponseEntity<?> viewCylinder(@PathVariable int cylinderId) throws CylinderNotFoundException {
		Cylinder getCylinder = cylinderService.viewCylinder(cylinderId);
		return new ResponseEntity <Cylinder>(getCylinder, HttpStatus.OK);
	}
